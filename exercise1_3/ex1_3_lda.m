...
IRIS1reduced = meas_reduced(iris_labels == 0,:,:,:);    %Samples of Class 0
IRIS2reduced = meas_reduced(iris_labels == 1,:,:,:);    %Samples of Class 1
IRIS3reduced = meas_reduced(iris_labels == 2,:,:,:);	%Samples of Class 2

figure(4)
hold on
plot(IRIS1reduced(:, 1), IRIS1reduced(:, 2), 'bo');
plot(IRIS2reduced(:, 1), IRIS2reduced(:, 2), 'rs');
plot(IRIS3reduced(:, 1), IRIS3reduced(:, 2), 'g+');
title('Data visualiasation after  LDA')
hold off
